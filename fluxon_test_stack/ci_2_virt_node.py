...
PLACEHOLDER_WHEEL_NAME = "fluxon_py-0.0.0-ci-placeholder-cp38-abi3-manylinux_2_28_x86_64.whl"
...
def main() -> int:
    ...
    wheel_name = _find_single_wheel(release_dir, pattern="fluxon_py-*.whl", ctx="top-level release wheel")
