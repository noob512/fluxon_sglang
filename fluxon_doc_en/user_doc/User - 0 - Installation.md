...
- Fluxon core artifacts: `fluxon_py-*.whl`, `fluxon_pyo3-*.whl`, `pylib_src.tar.gz`, `install.py`, `fluxon_release.sha256`
...
cd fluxon_release
pip install fluxon_py-*.whl fluxon_pyo3-*.whl
```
...
| File | Description |
|---|---|
| `fluxon_py-*.whl` | `fluxon-py` Python distribution |
