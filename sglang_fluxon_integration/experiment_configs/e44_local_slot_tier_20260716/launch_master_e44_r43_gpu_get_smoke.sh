...
work="$root/services/master_work_${smoke_tag}_20260721"
log="$root/log/current_cpu_remote_20260710/master_${smoke_tag}_20260721.log"
...
echo "started GPU Get smoke master: tag=$smoke_tag session=$session log=$log"
