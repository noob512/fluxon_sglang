...
# Reuse only the manylinux Cargo target cache. The immutable v5 release
# directory remains untouched while this post-baseline candidate is built.
target=/mnt/nvme0/mjq_build/fluxon_e44_v5_perf_manylinux_target_20260718
release=/media/infra44/宝宝盘2/mjq_build/fluxon_e44_r15_selected_credit_20260718
