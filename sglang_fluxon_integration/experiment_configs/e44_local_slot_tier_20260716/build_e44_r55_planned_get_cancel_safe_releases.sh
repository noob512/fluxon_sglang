...
export E44_BUILD_GPU_RELEASE="${E44_BUILD_GPU_RELEASE:-/mnt/nvme0/mjq_build/fluxon_e44_r55_planned_get_cancel_safe_gpu_cuda_20260723}"
export E44_BUILD_CPU_RELEASE="${E44_BUILD_CPU_RELEASE:-/mnt/nvme0/mjq_build/fluxon_e44_r55_planned_get_cancel_safe_cpu_host_20260723}"
...
export E44_BUILD_FINALIZE_ONLY="${E44_R55_FINALIZE_ONLY:-0}"
...
PYTHONDONTWRITEBYTECODE=1 python3 -B -m py_compile \
  "$script_dir/smoke_e44_r55_planned_cpu_stress.py"
...
for release in "$E44_BUILD_GPU_RELEASE" "$E44_BUILD_CPU_RELEASE"; do
  install -m 0644 \
    "$script_dir/../../Fluxon/fluxon_rs/fluxon_kv/src/kv_ssd_storage.rs" \
    "$release/source_kv_ssd_storage.rs"
  install -m 0755 \
    "$script_dir/../e16bb_rdma_numa1_20260714/start_gpu_stack_owner_numa1.sh" \
    "$release/start_gpu_stack_owner_numa1_ssd.sh"
  install -m 0755 \
    "$script_dir/../e16bb_rdma_numa1_20260714/start_cpu_owner_numa1.sh" \
    "$release/start_cpu_owner_numa1_ssd.sh"
  install -m 0644 \
    "$script_dir/unified_radix_cache_e44_r54_prefetch_timeline_observe.py" \
  ...
  install -m 0755 \
    "$script_dir/smoke_e44_r55_planned_cpu_stress.py" \
    "$release/smoke_e44_r55_planned_cpu_stress.py"
  (
    cd "$release"
