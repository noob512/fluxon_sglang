...
BASELINE_SHA256 = "9ae25216085dec9c76fe3b7a40451e6510320045eec77032c0838fc6f2ce2f5e"
CANDIDATE_SHA256 = "ad8475eb4c45228491c0094c3bbcbfcb2c84761a0d62d1dbb1b19c3ee318897a"
...
def main() -> None:
    ...
    required_once = (
        ...
        "total_before + total_tokens > device_prefetch_budget",
    ...
    gate_positions = [gate_source.index(marker) for marker in gate_order]
    if gate_positions != sorted(gate_positions):
        raise AssertionError("device headroom must be sampled before admission")

    tree = ast.parse(source, filename=str(args.candidate))
    compile(tree, str(args.candidate), "exec")
    print(f"e44 r133 device-headroom validation: passed sha256={actual_candidate}")
