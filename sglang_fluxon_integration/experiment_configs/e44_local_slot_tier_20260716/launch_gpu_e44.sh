...
test "$(sha256sum "$site/sglang/srt/mem_cache/unified_radix_cache.py" | awk '{print $1}')" = dd655ce6e09b3a1e38917b1329f897c9da3e45080131377fe1144e7329e8317d
...
export FLUXON_EXTERNAL_VENV_DIR=/storage/zth/sglang_l13_fluxon_v2/venv-fluxon-e44-r2-20260716
...
export FLUXON_EXTERNAL_OWNER_SESSION="zth_fluxon_owner_e44_r2_${node}"
export SGLANG_EXTERNAL_SESSION="zth_sglang_e44_r2_${node}_tp2"
export SGLANG_EXTERNAL_LOG_SUFFIX=_e44_r2_20260716
export SGLANG_EXTERNAL_HICACHE_KEY_PREFIX=fluxon_external_e44_r2_20260716
...
export FLUXON_EXTERNAL_DISABLE_OBSERVABILITY=true FLUXON_EXTERNAL_ICEORYX_EXTERNAL_BUSY_POLL=false FLUXON_EXTERNAL_ICEORYX_OWNER_CLIENT_BUSY_POLL=true
export FLUXON_EXTERNAL_EXPECTED_PYO3_SHA256=4061fe9f085fdebdfdfe49424106684d943c246905fb7ca301b7d7c11dd4ec38
