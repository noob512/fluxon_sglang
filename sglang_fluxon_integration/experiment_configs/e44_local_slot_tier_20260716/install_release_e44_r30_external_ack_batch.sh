...
case "$role" in
  gpu)
    ...
    venv=/storage/zth/sglang_l13_fluxon_v2/venv-fluxon-e44-r30-external-ack-batch-20260719
    python_version=3.10
    dependency_site=
    ;;
  cpu)
    ...
    venv=/storage/mjq/sglang_fluxon/fluxon_cpu/venv-fluxon-e44-r30-external-ack-batch-20260719
    python_version=3.12
