...
venv=/storage/zth/sglang_l13_fluxon_v2/venv-fluxon-e44-r2-20260716
work="$root/services/master_work_e44_r3_20260716"
config="$root/e16bk_fluxon_specific_12qps_20260714/master_config_sync4.yaml"
log="$root/log/current_cpu_remote_20260710/master_e44_r3_20260716.log"
rm -rf "$work"
