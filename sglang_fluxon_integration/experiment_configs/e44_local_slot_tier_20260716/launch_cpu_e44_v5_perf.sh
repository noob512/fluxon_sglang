...
export FLUXON_CPU_PYTHON_BIN="$E44_PERF_VENV_CPU/bin/python"
export FLUXON_CPU_SITE_PACKAGES="$E44_PERF_VENV_CPU/lib/python3.12/site-packages"
...
exec bash "$root/experiment_e16bb_rdma_numa1_20260714/launch_cpu_e16bb.sh" "$root" "$E44_PERF_RUN_ID"
