...
export E44_DEPLOY_GPU_RELEASE="${E44_DEPLOY_GPU_RELEASE:-/mnt/nvme0/mjq_build/fluxon_p14_burst_gpu_cuda_20260804}"
export E44_DEPLOY_CPU_RELEASE="${E44_DEPLOY_CPU_RELEASE:-/mnt/nvme0/mjq_build/fluxon_p14_burst_cpu_host_20260804}"
export E44_DEPLOY_GPU_REMOTE_RELEASE="${E44_DEPLOY_GPU_REMOTE_RELEASE:-/storage/mjq/sglang_fluxon/releases/fluxon_p14_burst_reserve_gpu_20260804}"
export E44_DEPLOY_CPU_REMOTE_RELEASE="${E44_DEPLOY_CPU_REMOTE_RELEASE:-/storage/mjq/sglang_fluxon/releases/fluxon_p14_burst_reserve_cpu_20260804}"
export E44_DEPLOY_GPU_VENV="${E44_DEPLOY_GPU_VENV:-/storage/zth/sglang_l13_fluxon_v2/venv-fluxon-e44-p14-burst-reserve-gpu-20260804}"
export E44_DEPLOY_CPU_VENV="${E44_DEPLOY_CPU_VENV:-/tmp/fluxon_runtime/venv-p14-burst-reserve-cpu-py311-20260804}"
...
export E44_DEPLOY_VARIANT="${E44_DEPLOY_VARIANT:-tier1_independent_005_netobs_enddepth288_p14_burst_reserve_r103_adapter}"
...
export E44_DEPLOY_EXPECTED_SOURCE_COMMIT="${E44_DEPLOY_EXPECTED_SOURCE_COMMIT:-1ed7e0b5b9dcd2945de8fbeba0127903a51ac644}"
export E44_DEPLOY_EXPECTED_PYO3_SHA256="${E44_DEPLOY_EXPECTED_PYO3_SHA256:-2542b33e9528117e62e28a7d22035a5d2fe57042e01cfe3524a2a06f947b58fe}"
...
test "$E44_DEPLOY_VARIANT" = tier1_independent_005_netobs_enddepth288_p14_burst_reserve_r103_adapter
...
for release in "$E44_DEPLOY_GPU_RELEASE" "$E44_DEPLOY_CPU_RELEASE"; do
  ...
  grep -F 'owner_local_reserve_physical_grant_count' \
    "$release/source_kv_lib.rs" >/dev/null
  grep -F 'physical_target_grants' \
    "$release/source_client_local_reserve_rebalance.rs" >/dev/null
