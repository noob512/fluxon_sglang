...
export SGLANG_EXTERNAL_LOG_SUFFIX="_${E44_PERF_RUN_ID}_20260718"
export SGLANG_EXTERNAL_HICACHE_KEY_PREFIX="fluxon_external_${E44_PERF_RUN_ID}_20260718"
...
export SGLANG_EXTERNAL_REPLICA_TASK_CONFIG_JSON="$E44_PERF_REPLICA_TASK_JSON"
