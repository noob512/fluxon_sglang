...
tag=fluxon_e44_r7_cohort_dedup_s96_t24_sys8192_out8_c24_session_stream_depth160_hot090_pipe64_20260717
...
(
  cd "$workdir"
  "$python" workload_agent_multiturn_long_context.py --cluster-state "$base/cluster_e44_r7.env" \
