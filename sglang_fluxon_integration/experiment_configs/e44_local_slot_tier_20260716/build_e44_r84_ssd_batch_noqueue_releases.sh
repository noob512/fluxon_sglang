...
export E44_BUILD_GPU_RELEASE="${E44_BUILD_GPU_RELEASE:-/mnt/nvme0/mjq_build/fluxon_e44_r84_ssd_batch_noqueue_gpu_cuda_20260725}"
export E44_BUILD_CPU_RELEASE="${E44_BUILD_CPU_RELEASE:-/mnt/nvme0/mjq_build/fluxon_e44_r84_ssd_batch_noqueue_cpu_host_20260725}"
...
export E44_R55_FINALIZE_ONLY="${E44_R84_FINALIZE_ONLY:-0}"
