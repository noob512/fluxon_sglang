...
local_release=/mnt/nvme0/mjq_build/fluxon_e44_r31_source_fence_wait_20260719
remote_release=/storage/mjq/sglang_fluxon/releases/fluxon_e44_r31_source_fence_wait_20260719
...
expected_wheel_sha256=81a66946b4babb28194d4bb089ca5b15dd805cbdec06198ff1afe4033101efb8
...
deploy_node() {
  ...
  scp -q -o BatchMode=yes -o StrictHostKeyChecking=no -P "$port" \
    ...
    "$experiment/install_release_e44_r31_source_fence_wait.sh" \
    "$experiment/master_config_e44_r31_source_fence_wait_netobs.yaml" \
  ...
  ssh -o BatchMode=yes -o StrictHostKeyChecking=no -p "$port" "root@$host" \
    "set -e; \
     ...
     bash -n '$remote_experiment/e44_v5_perf_variant_20260718.sh' \
       '$remote_experiment/install_release_e44_r31_source_fence_wait.sh' \
     ...
     bash '$remote_experiment/install_release_e44_r31_source_fence_wait.sh' '$role' '$remote_release/$wheel_name' '$expected_pyo3_sha256'; \
