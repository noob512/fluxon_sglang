...
test "$(sha256sum "$site/sglang/srt/mem_cache/unified_radix_cache.py" | awk '{print $1}')" = 0a71734f14eada7933e95819c8c918b6ef9a9320e81df0ed9617fcf0ceff77e4
...
export FLUXON_EXTERNAL_OWNER_SESSION="zth_fluxon_owner_e44_r3_${node}"
export SGLANG_EXTERNAL_SESSION="zth_sglang_e44_r3_${node}_tp2"
export SGLANG_EXTERNAL_LOG_SUFFIX=_e44_r3_20260716
export SGLANG_EXTERNAL_HICACHE_KEY_PREFIX=fluxon_external_e44_r3_20260716
