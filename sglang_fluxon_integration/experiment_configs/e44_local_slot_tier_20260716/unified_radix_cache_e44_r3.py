        ...
        if self._is_fluxon_hostless_full_mode():
            if not hostless_storage_ready:
                if (
                    ...
                    return
                if self._ensure_fluxon_hostless_write_through_recoverable(
                    node
                ):
                    self._evict_to_fluxon_storage(node, tracker)
                    return
    ...
    def prefetch_from_storage(
        ...
        if self._is_fluxon_hostless_full_mode():
            ...
            if hash_values:
                ...
                transferable_pages = int(getattr(kv_result, "transferable_len", 0))
                ...
                try:
                    if operation is not None:
                        ...
                        logger.info(
                            ...
                            (time.perf_counter() - operation.queued_at) * 1000.0,
                            (
