...
case "$role" in
  gpu)
    ...
    venv=/storage/zth/sglang_l13_fluxon_v2/venv-fluxon-e44-r18-direct-delete-singleflight-20260719
    python_version=3.10
    dependency_site=
    ;;
  cpu)
    ...
    venv=/storage/mjq/sglang_fluxon/fluxon_cpu/venv-fluxon-e44-r18-direct-delete-singleflight-20260719
    python_version=3.12
...
if [ "${E44_SKIP_IMPORT_PROBE:-0}" != 1 ]; then
...
PY
  ...
  echo "skip import probe because E44_SKIP_IMPORT_PROBE=1"
fi
