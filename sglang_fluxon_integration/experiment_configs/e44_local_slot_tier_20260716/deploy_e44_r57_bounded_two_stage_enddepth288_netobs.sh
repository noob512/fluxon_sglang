...
# r57 is a source-only correctness repair over the sealed r55 Fluxon wheel.
# The shared-stage deployer still verifies every installed artifact per node.
...
export E44_DEPLOY_VARIANT=tier1_independent_005_netobs_enddepth288_gpu_direct_r57_bounded_two_stage
...
export E44_DEPLOY_EXPECTED_ADAPTER_SHA256=18e5e43d9ebe13cedcc83679cbc59ec8ebfadd594d995d5817d26968f191bf5b
