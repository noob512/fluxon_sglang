...
export FLUXON_CPU_PYTHON_BIN="$root/venv-fluxon-e44-r11-20260717/bin/python"
export FLUXON_CPU_SITE_PACKAGES="$root/venv-fluxon-e44-r11-20260717/lib/python3.12/site-packages"
...
exec bash "$root/experiment_e16bb_rdma_numa1_20260714/launch_cpu_e16bb.sh" "$root" e44_r11
