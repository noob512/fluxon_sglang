...
export FLUXON_EXTERNAL_VENV_DIR=/storage/zth/sglang_l13_fluxon_v2/venv-fluxon-e44-r10-20260717
# Fair 128 GiB per-GPU cache budget: 96 GiB Fluxon owner + 32 GiB HiCache L2.
export FLUXON_EXTERNAL_OWNER_DRAM_BYTES=103079215104
...
export FLUXON_EXTERNAL_OWNER_LOCAL_RESERVE_PAYLOAD_CAPACITY_BYTES=92771293593
export FLUXON_EXTERNAL_CLEAN_START=1
export FLUXON_EXTERNAL_OWNER_SESSION="zth_fluxon_owner_e44_r10_${node}"
export SGLANG_EXTERNAL_SESSION="zth_sglang_e44_r10_${node}_tp2"
export SGLANG_EXTERNAL_LOG_SUFFIX=_e44_r10_20260717
export SGLANG_EXTERNAL_HICACHE_KEY_PREFIX=fluxon_external_e44_r10_20260717
...
export FLUXON_EXTERNAL_EXPECTED_PYO3_SHA256=a0ca56d2d7b69a5f6d8963f0740f2b3bf2d2cdd969e82dfabbf8dd74cfa55af8
