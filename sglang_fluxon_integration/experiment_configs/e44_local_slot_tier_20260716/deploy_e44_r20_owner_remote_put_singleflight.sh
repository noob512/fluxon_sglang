...
local_release=/storage/mjq/sglang_fluxon/releases/fluxon_e44_r20_owner_remote_put_singleflight_tier1_075_20260719
remote_release=/storage/mjq/sglang_fluxon/releases/fluxon_e44_r20_owner_remote_put_singleflight_tier1_075_20260719
...
expected_wheel_sha256=edc4175653f0c4fa31b0a4d9dfdb14dd403ca408a96c7189bd9a41275cd1a93e
expected_pyo3_sha256=98442cc4312cee2bc3b48715eccb6aa0545b99778997f98f4de4a3fec23746eb
...
deploy_node() {
  ...
  scp -q -o BatchMode=yes -o StrictHostKeyChecking=no -P "$port" \
    ...
    "$experiment/install_release_e44_r20_owner_remote_put_singleflight.sh" \
    "$experiment/master_config_e44_r20_owner_remote_put_singleflight_tier1_075.yaml" \
  ...
  ssh -o BatchMode=yes -o StrictHostKeyChecking=no -p "$port" "root@$host" \
    "set -e; cd '$remote_release'; sha256sum -c fluxon_release.sha256; test \"\$(sha256sum '$remote_release/$wheel_name' | awk '{print \$1}')\" = '$expected_wheel_sha256'; bash -n '$remote_experiment/e44_v5_perf_variant_20260718.sh' '$remote_experiment/install_release_e44_r20_owner_remote_put_singleflight.sh' '$remote_experiment/fluxon_wait_ready.sh' '$remote_experiment/start_control_e44_v5_perf.sh' '$remote_experiment/launch_master_e44_v5_perf.sh' '$remote_experiment/launch_gpu_e44_v5_perf.sh' '$remote_experiment/launch_cpu_e44_v5_perf.sh' '$remote_experiment/launch_router_e44_v5_perf.sh' '$remote_experiment/run_workload_e44_v5_perf.sh'; bash '$remote_experiment/install_release_e44_r20_owner_remote_put_singleflight.sh' '$role' '$remote_release/$wheel_name' '$expected_pyo3_sha256'; ln -sfn '$remote_release' '$root/fluxon_release'; test \"\$(readlink -f '$root/fluxon_release')\" = '$remote_release'"
