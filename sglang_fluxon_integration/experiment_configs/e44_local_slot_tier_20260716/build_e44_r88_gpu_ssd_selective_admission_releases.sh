...
export E44_BUILD_GPU_RELEASE="${E44_BUILD_GPU_RELEASE:-/mnt/nvme0/mjq_build/fluxon_e44_r88_gpu_ssd_selective_admission_gpu_cuda_20260725}"
export E44_BUILD_CPU_RELEASE="${E44_BUILD_CPU_RELEASE:-/mnt/nvme0/mjq_build/fluxon_e44_r88_gpu_ssd_selective_admission_cpu_host_20260725}"
...
export E44_R55_FINALIZE_ONLY="${E44_R88_FINALIZE_ONLY:-0}"
