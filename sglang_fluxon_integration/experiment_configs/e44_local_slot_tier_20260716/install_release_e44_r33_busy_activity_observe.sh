...
case "$role" in
  gpu)
    ...
    venv=/storage/zth/sglang_l13_fluxon_v2/venv-fluxon-e44-r33-busy-activity-observe-20260720
    python_version=3.10
    dependency_site=
    ;;
  cpu)
    ...
    venv=/storage/mjq/sglang_fluxon/fluxon_cpu/venv-fluxon-e44-r33-busy-activity-observe-20260720
    python_version=3.12
