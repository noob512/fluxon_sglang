...
local_release=/mnt/nvme0/mjq_build/fluxon_e44_r33_busy_activity_observe_20260720
remote_release=/storage/mjq/sglang_fluxon/releases/fluxon_e44_r33_busy_activity_observe_20260720
...
expected_wheel_sha256=548b956c877e9d7a35fe9ad815714b0eab1848f50ecde4b52090943a4e471208
expected_pyo3_sha256=d998fb2a7699a8b44d21b059785c16175359ea5ea120a71352fa6bb80224b5de
...
deploy_node() {
  ...
  scp -q -o BatchMode=yes -o StrictHostKeyChecking=no -P "$port" \
    ...
    "$experiment/install_release_e44_r33_busy_activity_observe.sh" \
    "$experiment/master_config_e44_r33_busy_activity_observe_enddepth288_netobs.yaml" \
  ...
  ssh -o BatchMode=yes -o StrictHostKeyChecking=no -p "$port" "root@$host" \
    "set -e; \
     ...
     grep -F 'master key activity runtime' '$remote_release/source_master_mod.rs' >/dev/null; \
     ...
     source '$remote_experiment/e44_v5_perf_variant_20260718.sh' tier1_independent_005_netobs_enddepth288_busy_activity_observe; \
     test "\$E44_PERF_RUN_ID" = e44_r33_busy_activity_observe_enddepth288_netobs; \
     ...
     bash -n '$remote_experiment/e44_v5_perf_variant_20260718.sh' \
       '$remote_experiment/install_release_e44_r33_busy_activity_observe.sh' \
     ...
     bash '$remote_experiment/install_release_e44_r33_busy_activity_observe.sh' '$role' '$remote_release/$wheel_name' '$expected_pyo3_sha256'; \
